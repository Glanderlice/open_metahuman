...
from modules.lipsync_module.musetalk.models.unet import UNet, PositionalEncoding
from modules.lipsync_module.musetalk.models.vae import VAE
...
def load_all_model(model_root):
    audio_processor = Audio2Feature(model_path=f"{model_root}/whisper/tiny.pt")
    vae = VAE(model_path=f"{model_root}/sd-vae-ft-mse/")
    unet = UNet(unet_config=f"{model_root}/musetalk/musetalk.json",
                model_path=f"{model_root}/musetalk/pytorch_model.bin")
